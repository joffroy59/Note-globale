...
avec QuickAdd `BUTTON[insert-plugin-list-all]`  ❌
...
| Folder Note | 0.7.3 | ❌ || Homepage | 4.1 | ✅ |
| Image Converter | 1.3.3 | ✅ || JS Engine | 0.2.1 | ❌ |
| Local GPT | 1.14.7 | ✅ || MAKE.md | 1.0.2 | ❌ |
| Mononote | 1.2.2 | ✅ || Multi-Column Markdown | 0.9.1 | ❌ |
| Admonition | 10.3.2 | ✅ || Advanced Slides | 1.20.0 | ❌ |
| Banners | 1.3.3 | ❌ || Better Command Palette | 0.17.1 | ❌ |
| Checklist | 2.2.13 | ❌ || Columns | 1.6.1 | ❌ |
| Custom Frames | 2.4.7 | ❌ || Day Planner | 0.27.0 | ❌ |
...
| Spaced Repetition | 1.13.2 | ❌ || Table Generator | 1.4.1 | ✅ |
| TagFolder | 0.18.9 | ❌ || Archiver | 0.26.1 | ❌ |
| Task Progress Bar | 2.0.0 | ❌ || Tasks | 7.14.0 | ✅ |
| Text Generator | 0.7.47 | ✅ || Version History Diff | 2.2.1 | ❌ |
| BRAT | 1.0.6 | ✅ || Omnisearch | 1.25.2 | ❌ |
| Image in Editor | 2.2.6 | ❌ || Periodic Notes | 0.0.17 | ✅ |
| Pixel Banner | 2.21.2 | ✅ || Query Control | 0.7.13 | ✅ |
| QuickAdd | 1.11.5 | ✅ || Recent Files | 1.7.4 | ✅ |
| Smart Connections | 2.3.47 | ❌ || Smart Second Brain | 1.3.0 | ❌ |
| Spellcheck Toggler | 1.1.0 | ❌ || Advanced Tables | 0.22.1 | ❌ |
| Tag Wrangler | 0.6.1 | ❌ || Templater | 2.9.1 | ✅ |
| Text Extractor | 0.5.2 | ❌ || Vault Transfer | 1.2.3 | ✅ |
...
| Homepage | 4.1 | ✅ | homepage |
| Image Converter | 1.3.3 | ✅ | image-converter |
...
| Better Command Palette | 0.17.1 | ❌ | obsidian-better-command-palette |
...
| Pixel Banner | 2.21.2 | ✅ | pexels-banner |
| Query Control | 0.7.13 | ✅ | query-control |
