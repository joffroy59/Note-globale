...
`="[[Daily Note/"+ dateformat(date(yesterday), "yyyy") + "/" + dateformat(date(yesterday), "MM") + "/" + dateformat(date(yesterday), "WW") + "/📒" + dateformat(date(yesterday), "yyyy-MM-dd") + "|👈 yesterday]]"` | `="[[Daily Note/2025/01/📒" + dateformat(date(today), "yyyy-MM-dd") + "|👇 today]]"` | `="[[Daily Note/2025/01/📒" + dateformat(date(tomorrow), "yyyy-MM-dd") + "|👉 tomorrow]]"`
